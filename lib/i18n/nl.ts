export const nl = {
  ...
  settings: {
    ...
    mcFeedUrl: "MC-cloud Team-feed URL",
    mcFeedUrlDesc: "Directe cloudendpoint van Higgins Mission Control. De publieke versie gebruikt deze automatisch.",
    mcFeedUrlPlaceholder: "https://higgins-dash-bbdpujw2.manus.space/api/app/team-feed",
