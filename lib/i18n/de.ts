...
export const de: Translations = {
  ...
  agents: {
    ...
    sourceCached: "Letzter MC-Snapshot",
    sourceConnecting: "Verbindung mit Mission Control",
  ...
  settings: {
    ...
    mcFeedUrlDesc: "Direkter Cloud-Endpunkt von Higgins Mission Control. Die öffentliche Version verwendet ihn automatisch.",
